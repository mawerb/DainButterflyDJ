...
export type DatasourceType = "json" | "csv" | "xml" | "text";
export type ServiceDatasource<TInput extends z.ZodType = any> = {
    id: string;
    name: string;
    description: string;
    type: DatasourceType;
    input: TInput;
    getDatasource: (agentInfo: AgentInfo, params: z.input<TInput>) => Promise<any>;
};
...
export interface DAINService {
    ...
    getDatasources: () => ServiceDatasource[];
    getTools: () => ToolConfig[];
    ...
    findDatasource: (datasourceId: string) => ServiceDatasource | undefined;
    app: Hono;
    startService: () => Hono;
}
