...
function createBaseDAINService(config) {
    ...
    const startService = function () {
        ...
        }, tools, services, toolboxes, config.metadata, privateKey, config.contexts, config.pinnables, config.datasources);
        return app;
    };
    ...
    const getContexts = () => config.contexts;
    ...
    const findDatasource = (datasourceId) => config.datasources.find((datasource) => datasource.id === datasourceId);
    return {
        getMetadata,
        getServices,
        getTools,
