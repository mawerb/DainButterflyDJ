import { z } from "zod";
import { ToolConfig, ServiceConfig, ToolboxConfig, AgentInfo, PricingInfo, ServiceContext, ServicePinnable, ServiceDatasource } from "./types";
...
export declare function createDatasource<TInput extends z.ZodType>(config: ServiceDatasource<TInput>): ServiceDatasource<TInput>;
