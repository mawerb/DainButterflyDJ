...
exports.DatasourceTypeSchema = zod_1.z.enum(["json", "csv", "xml", "text"]);
exports.ServiceDatasourceSchema = zod_1.z.object({
    id: zod_1.z.string(),
    name: zod_1.z.string(),
    description: zod_1.z.string(),
